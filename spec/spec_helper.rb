...
# Load gem code
require_relative "../lib/quizly"

# Ensure namespaced models use the engine-style table name prefix
module Quizly
...
# Load app models explicitly (non-Rails spec environment)
Dir[File.expand_path("../app/models/**/*.rb", __dir__)].sort.each { |f| require f }

# In-memory database for model specs
